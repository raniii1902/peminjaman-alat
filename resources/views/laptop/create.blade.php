...
<div class="laptop-form-page">
    <section class="form-hero">
        <h2 class="hero-title">Tambah Inventaris PPLG</h2>
        <p class="hero-subtitle">Tambahkan data inventaris baru seperti laptop atau proyektor agar dapat dipakai pada proses peminjaman.</p>
    </section>
        ...
        <form action="{{ route('laptop.store') }}" method="POST">
            ...
            <div class="form-grid">
                <div class="form-group full">
                    ...
                    <input class="form-input" type="text" name="nama_laptop" value="{{ old('nama_laptop') }}" placeholder="Contoh: Asus VivoBook / Proyektor Epson" required>
                </div>
